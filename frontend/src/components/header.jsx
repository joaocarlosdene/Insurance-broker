...
export default props =>
    <Navbar className="fixed-top" bg="dark" variant="dark" expand="md">
        ...
        <Navbar.Toggle className="hamburguer"/>
        <NavbarCollapse className="menu-right">
            <Nav >
                <NavDropdown className="NavDropdown" title="Prime Seguros" menuVariant="dark">
                ...
                <NavDropdown className="NavDropdown" title="Para Você" menuVariant="dark">
                ...
                <NavDropdown className="NavDropdown" title="Para Empresa" menuVariant="dark">
                ...
                <NavDropdown className="NavDropdown" title="Sinistros" menuVariant="dark">
                ...
                <NavLink className="NavDropdown" href="/">Fale Conosco</NavLink>
            </Nav>
            </NavbarCollapse>
    </Navbar>
